...
namespace DigitalHijinks.MiKeys.Helpers
{
    public static class Globals
    {
        ...
        public static GraphicsDeviceManager GDM  = Main.graphics;
        public static GraphicsDevice GFX { get; set; }
        public static GameWindow GW { get; set; }
        public static SpriteBatch SBX = Main.spriteBatch;

        public static SpriteBatch spriteBatch = Main.spriteBatch;
        public static SpriteFont SF = ModContent.Request<SpriteFont>("VirtualJoystick/Fonts/FSEX302").Value;
        ...
        {
            DrawRect(Main.spriteBatch, new Vector2(rect.X, rect.Y), new Vector2(rect.X + rect.Width, rect.Y + rect.Height), borderColor, bgColor, thickness, fill);
        }
        ...
        {
            if (fill)
                DrawLine(Main.spriteBatch, new(point1.X, (point1.Y + point2.Y) / 2), new(point2.X, (point1.Y + point2.Y) / 2), bgColor, Math.Abs((point1.Y - point2.Y)));
            DrawLine(Main.spriteBatch, point1, new(point2.X, point1.Y), borderColor, thickness);
            DrawLine(Main.spriteBatch, point1, new(point1.X, point2.Y), borderColor, thickness);
            DrawLine(Main.spriteBatch, point2, new(point2.X, point1.Y), borderColor, thickness);
            DrawLine(Main.spriteBatch, point2, new(point1.X, point2.Y), borderColor, thickness);
        }
        ...
        public static void DrawLine(this SpriteBatch spriteBatch, Vector2 point1, Vector2 point2, Color color, float thickness = 1f, Texture2D t = null)
        {
            ...
            DrawLine(Main.spriteBatch, point1, distance, angle, color, thickness, t);
        }
        ...
        public static void DrawLine(this SpriteBatch spriteBatch, Vector2 point, float length, float angle, Color color, float thickness = 1f, Texture2D t = null)
        {
            ...
            Main.spriteBatch.Draw(t == null ? GetTexture(Main.spriteBatch) : t, point, null, color, angle, origin, scale, SpriteEffects.None, 1);
        }
    }
}
